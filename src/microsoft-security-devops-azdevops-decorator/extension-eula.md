# MICROSOFT SOFTWARE LICENSE TERMS</br> MICROSOFT SECURITY DEVOPS – AZURE DEVOPS EXTENSION
...
**b) Third Party Software.** The software may include third party applications that are licensed to you under this agreement or under their own terms. License terms, notices, and acknowledgements, if any, for the third party applications may be accessible online at https://aka.ms/sca-tpn.  Even if such applications are governed by other agreements, the disclaimer, limitations on, and exclusions of damages below also apply to the extent allowed by applicable law.

**c) Application Downloads.**  This software may download other Microsoft or third party applications for use in conjunction with the software through corresponding build tasks. These applications are licensed to you under this agreement, and you may use them solely in conjunction with the software. These applications must be deleted from the corresponding build agents upon completion of use of the software on such build agents.
...
**a) Period.** This agreement is effective on your acceptance and terminates on the earlier of (i) 30 days following first availability of a commercial release of the software or (ii) December 31, 2018. Microsoft may extend this agreement in its discretion.
...
**4. CONFIDENTIAL INFORMATION.** The software, including its user interface, features and documentation, is confidential and proprietary to Microsoft and its suppliers.
